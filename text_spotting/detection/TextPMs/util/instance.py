import cv2
import numpy as np
from text_spotting.detection.TextPMs.util.misc import find_bottom, find_long_edges, split_edge_seqence, norm2, split_edge_seqence_by_step
from text_spotting.detection.TextPMs.util.detection import sigmoid_alpha
