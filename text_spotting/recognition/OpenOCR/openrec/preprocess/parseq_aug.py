...
from text_spotting.recognition.OpenOCR.openrec.preprocess import auto_augment
from text_spotting.recognition.OpenOCR.openrec.preprocess.auto_augment import _LEVEL_DENOM, LEVEL_TO_ARG, NAME_TO_OP, _randomly_negate, rotate
