...
from text_spotting.recognition.OpenOCR.openrec.modeling.decoders.abinet_decoder import BCNLanguage, PositionAttention, _get_length
from text_spotting.recognition.OpenOCR.openrec.modeling.decoders.nrtr_decoder import PositionalEncoding, TransformerBlock
