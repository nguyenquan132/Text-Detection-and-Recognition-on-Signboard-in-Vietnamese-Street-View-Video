...
from text_spotting.recognition.OpenOCR.openrec.modeling.common import Mlp
from text_spotting.recognition.OpenOCR.openrec.modeling.decoders.nrtr_decoder import PositionalEncoding, Embeddings, MultiheadAttention
