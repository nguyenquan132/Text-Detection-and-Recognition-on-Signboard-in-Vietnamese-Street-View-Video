...
from text_spotting.recognition.OpenOCR.openrec.modeling.decoders.nrtr_decoder import Embeddings, PositionalEncoding, TransformerBlock  # , Beam
from text_spotting.recognition.OpenOCR.openrec.modeling.decoders.visionlan_decoder import Transformer_Encoder
