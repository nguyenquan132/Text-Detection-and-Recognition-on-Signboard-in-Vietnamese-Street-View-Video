...
from text_spotting.recognition.OpenOCR.openrec.modeling.common import Block, PatchEmbed
from text_spotting.recognition.OpenOCR.openrec.modeling.encoders.svtrv2_lnconv import Feat2D, LastStage
