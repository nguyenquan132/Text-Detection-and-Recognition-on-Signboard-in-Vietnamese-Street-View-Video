...
* **DBNet** – * **DBNet** – adapted from the official repositories [PaddleOCR2Pytorch](../src/text_det/PaddleOCR2Pytorch/README.md) and [DBNet.pytorch](../src/text_det/DBNet.pytorch/README.md)
