"""
The classes `MakeShrinkMap` and the functions `shrink_polygon_py`, `shrink_polygon_pyclipper` are adapted from:
DBNet.pytorch repository: https://github.com/WenmuZhou/DBNet.pytorch.git
